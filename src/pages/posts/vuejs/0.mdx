...
아래 소개할 내용을 토대로 깃허브에 보일러플레이트를 만들어두었습니다.<br />
필요하신 분들은 아래 링크를 참고해주세요.
- [Vuyah - Vue3 Boilerplate | Github](https://github.com/oobg/Vuyah)
...
[32m✔[0m Add ESLint for code quality? … [36mYes[0m
[32m✔[0m Add Prettier for code formatting? … [36mYes[0m
	...
	<FileTree.Folder name="src" defaultOpen>
		...
		<FileTree.Folder name="widget" defaultOpen>
			...
			<FileTree.Folder name="layout">
				...
				<FileTree.File name="ContentLayout.vue" />
...
<Callout type="info">
	레이아웃과 뷰 컴포넌트를 동적으로 로딩할 수 있습니다.<br />
...
footer 가 main 의 자식과 같은 레벨에 위치해야 할 경우도 있습니다.
이를 위해 **ContentLayout.vue** 와 같은 레이아웃을 추가로 생성하여 사용할 수 있습니다.

```vue filename="src/widget/layout/ContentLayout.vue" copy
<template>
  <default-header />
  <main>
    <router-view />
...
2. **computed** 함수를 사용하여 라우터의 **meta.layout** 속성을 감시하고, 변경되면 **layout** 변수에 할당합니다.
...
지금까지 소개했던 내용을 토대로 깃허브에 보일러플레이트를 만들어두었습니다.<br />
필요하신 분들은 아래 링크를 참고해주세요.
- [Vuyah - Vue3 Boilerplate | Github](https://github.com/oobg/Vuyah)