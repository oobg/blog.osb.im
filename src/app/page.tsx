...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center">
      ...
      {/*<MainLogo />*/}
      <div className="flex-grow h-full m-3 p-3 w-full flex flex-col">
      ...
      <footer
        className="min-w-16 h-16 flex justify-between mb-3 pt-2 px-1 items-center bg-neutral-600 bg-opacity-30 rounded-xl border border-neutral-600">
